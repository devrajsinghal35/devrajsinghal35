...
- Identified and documented vulnerabilities including **SQL Injection, XSS, and CSRF**.
- Used **Wireshark** for packet analysis and identified plaintext credential exposure.
